...
final class EmotionalTestViewModel: ObservableObject {
    ...
    func getResult() -> TestResult {
        ...
        switch result {
        case 0...20:
            return TestResult(score: result, title: "Very low", description: "In this case, it means that you have a poor understanding of emotions, neither your own nor those of others. You are not able to appreciate yourself and do not see your full potential. You need to work on your life skills to be able to have more satisfactory relationships with others, but above all, to improve your relationship with yourself.")
            
        case 21...35:
            return TestResult(score: result, title: "Low", description: "If you have a low score, you have some emotional skills, but you still need to improve them significantly. You need to do some personal work to get to know yourself better and appreciate who you are and what you can become. You need to recognize and identify your emotions, learn to manage them, and express them assertively")
            
        case 36...46:
            return TestResult(score: result, title: "Medium-low", description: "Here you are halfway to improving your emotional skills, you are on the verge of achieving it. You already know a lot of things about your thoughts and feelings, but you need to learn how to deal with your emotions with others in a proper and effective way. You need to improve your social skills.")
            
        case 46...79:
            return TestResult(score: result, title: "Medium-high", description: "Not bad at all, you know who you are, your thoughts and feelings are perfectly recognizable. You know how to manage your emotions to feel good about yourself and not let negative thoughts ruin your day. You have good relationships with others, and you know how to communicate assertively.")
            
        case 80...90:
            return TestResult(score: result, title: "Very high", description: "If you received this score, congratulations! You are an emotionally intelligent person. You have great relationships and you will probably find that people look to you for advice. But you have to be careful because you can put your own needs aside. You have high leadership potential, so don't hesitate to look for opportunities to reach your full potential. The good thing about all of this is that you know your abilities as well as your weaknesses, you recognize your successes, you know how to communicate appropriately with others, and you can resolve conflicts with empathy and assertiveness. Congratulations!")
            
        default:
            return TestResult(score: result, title: "Oops!", description: "Something went wrong!")
        }
    }
}
